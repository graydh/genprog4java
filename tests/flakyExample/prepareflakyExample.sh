...
#./prepareflakyExample.sh /home/mau/Research/genprog4java
...
javac -d bin/ src/flakyExample/RandomExample.java 
...
#rm -rf bin/packageflakyExample/

#PACKAGEDIR=${JAVADIR//"/"/"."}

#Create config file 
FILE=./flakyExample.config
/bin/cat <<EOM >$FILE
javaVM = /usr/bin/java
popsize = 20
seed = 0
...
targetClassName = flakyExample.RandomExample
EOM
